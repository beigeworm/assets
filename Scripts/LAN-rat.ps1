...
while ($httpsrvlsnr.IsListening) {
    try {
        ...
        if ($ctx.Request.RawUrl -eq "/") {
            ...
            $html += "<li><a href='/sound'>Play All Windows Sounds</a></li>"
            $html += "<li><a href='/dark'>Enable Dark Mode</a></li>"
            $html += "<li><a href='/light'>Enable Light Mode</a></li>"
            $html += "<li><a href='/rroll'>Start RickRoll</a></li>"
